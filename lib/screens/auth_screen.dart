...
//
// L'inscription est geree par /register -> RegistrationJourneyScreen.
// Gestion d'erreurs Firebase traduite en francais via AuthService.translateError.
// ─────────────────────────────────────────────────────────────────────────────
...
class _AuthScreenState extends ConsumerState<AuthScreen>
  ...
  Future<void> _onPinConfirm() async {
    ...
    // Connexion kids : PIN (re-auth silencieuse si session expiree)
  ...
  // -- Kids form -- PIN connexion uniquement
  ...
  Widget _buildActionButton(TextTheme tt, bool isDark) {
    // Kids : the PIN pad OK is the main action, button hidden
    ...
    return AnimatedContainer(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(28),
          onTap: authState.isLoading ? null : _authenticate,
          child: Center(
