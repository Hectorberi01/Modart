...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _updateConsent(String key, bool value) async {
    await context.read<AuthProvider>().updateProfile({key: value});
  }

  Future<void> _signOut() async {
    final profileType =
        context.read<AuthProvider>().userProfile?.profileType ?? ProfileType.urban;
  ...
  Widget build(BuildContext context) {
    ...
    final UserProfile? profile = auth.userProfile;
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed:
                                  auth.isLoading ? null : _savePersonalInfo,
                              child:
                                  auth.isLoading
                                      ? const SizedBox(
                                        width: 18,
